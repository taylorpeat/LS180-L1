...
DROP SCHEMA public;
--
-- Name: public; Type: SCHEMA; Schema: -; Owner: taylorpeat
--

CREATE SCHEMA public;


ALTER SCHEMA public OWNER TO taylorpeat;

--
-- Name: SCHEMA public; Type: COMMENT; Schema: -; Owner: taylorpeat
--
...
--
-- Name: addresses; Type: TABLE; Schema: public; Owner: taylorpeat
--
...
ALTER TABLE addresses OWNER TO taylorpeat;
...
--
-- Name: books_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: taylorpeat
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: taylorpeat
--
...
ALTER TABLE users OWNER TO taylorpeat;

--
-- Name: users_books; Type: TABLE; Schema: public; Owner: taylorpeat
--
...
ALTER TABLE users_books OWNER TO taylorpeat;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: taylorpeat
--
...
ALTER TABLE users_id_seq OWNER TO taylorpeat;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: taylorpeat
--
...
--
-- Name: books id; Type: DEFAULT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: taylorpeat
--
...
--
-- Data for Name: addresses; Type: TABLE DATA; Schema: public; Owner: taylorpeat
--
...
INSERT INTO books VALUES (1, 'My First SQL book', 'Mary Parker', '2017-07-02 00:24:09.945711', NULL);
INSERT INTO books VALUES (3, 'My Third SQL book', 'Cary Flint', '2017-07-02 00:24:09.949478', NULL);
...
INSERT INTO reviews VALUES (1, 1, 1, 'My first review', NULL, '2017-07-02 00:24:09.946846');
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: taylorpeat
--

INSERT INTO users VALUES (1, 'John Smith', true, '2017-07-02 00:24:09.942902');
INSERT INTO users VALUES (2, 'Jane Smiley', true, '2017-07-02 00:24:09.948185');
INSERT INTO users VALUES (3, 'Alice Munro', true, '2017-07-02 00:24:09.949193');


--
-- Data for Name: users_books; Type: TABLE DATA; Schema: public; Owner: taylorpeat
--

INSERT INTO users_books VALUES (1, 1, '2017-07-02 00:24:09.946207', NULL);


--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: taylorpeat
--
...
--
-- Name: addresses addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: books books_isbn_key; Type: CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: users_books users_books_pkey; Type: CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: addresses fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: reviews reviews_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: reviews reviews_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: users_books users_books_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: taylorpeat
--
...
--
-- Name: users_books users_books_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: taylorpeat
--
